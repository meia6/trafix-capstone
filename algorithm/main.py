...
def traffic_init(speed_limit, distances, max_hold_time, min_hold_time, ped_min_hold_time):
    ...
    while(program_running):
        ...
        camera_count_N=Videoinput.video_input('traffic1.mp4')
        camera_count_S=Videoinput.video_input('traffic2.mp4')
        camera_count_W=Videoinput.video_input('traffic3.mp4')
        camera_count_E=Videoinput.video_input('traffic4.mp4')
